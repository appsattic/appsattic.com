...
APPSATTIC_NAKED_DOMAIN=`ask.sh pow APPSATTIC_APEX 'What is the apex (e.g. localhost:9670 or appsattic.com) :'`
...
m4 \
    -D __APPSATTIC_PORT__=10877{NAME_UPPER}_PORT \
    -D __APPSATTIC_APEX__=10877{NAME_UPPER}_APEX \
    -D __APPSATTIC_BASE_URL__=10877{NAME_UPPER}_BASE_URL \
